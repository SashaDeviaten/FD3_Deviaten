...
var _MobileCompany = __webpack_require__(34);
...
var _MobileClient = __webpack_require__(38);
...
var MobileCompany = function (_React$PureComponent) {
    ...
    function MobileCompany() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MobileCompany.__proto__ || Object.getPrototypeOf(MobileCompany)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            _this.setState({ clients: newClients });
        }, _this.changeClientFio = function (clientId, newFio) {
            var newClients = [].concat(_toConsumableArray(_this.state.clients));
            ...
            _this.setState({ clients: newClients });
        }, _this.changeClientBalance = function (clientId, newBalance) {
            var newClients = [].concat(_toConsumableArray(_this.state.clients));
            newClients.forEach(function (c, i) {
                if (c.id === clientId) {
                    var newClient = _extends({}, c);
            ...
            _this.setState({ clients: newClients });
        }, _this.setNewClientFioRef = function (ref) {
            _this.newClientFioRef = ref;
    ...
    _createClass(MobileCompany, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'button', value: '\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043A\u043B\u0438\u0435\u043D\u0442\u0430', onClick: this.showNewClientCard }),
                this.state.showNewClientCard && _react2.default.createElement(
                    'div',
                    null,
    ...
    function MobileClient() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MobileClient.__proto__ || Object.getPrototypeOf(MobileClient)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            if (_this.newBalanceRef) {
                ...
                _this.props.cbChangeClientBalance(_this.state.info.id, newBalance);
            }
        }, _this.showFioInput = function () {
            _this.showButtons();
            _this.setState({ showFioInput: true });
        }, _this.showBalanceInput = function () {
            _this.showButtons();
            _this.setState({ showBalanceInput: true });
        }, _this.setNewFioRef = function (ref) {
            _this.newFioRef = ref;
...
MobileClient.propTypes = {
    ...
    cbChangeClientFio: _propTypes2.default.func.isRequired,
    cbChangeClientBalance: _propTypes2.default.func.isRequired
