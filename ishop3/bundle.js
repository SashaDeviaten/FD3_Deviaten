...
var _ProductsBlock = __webpack_require__(26);

var _ProductsBlock2 = _interopRequireDefault(_ProductsBlock);

var _mobiles = __webpack_require__(34);

var _mobiles2 = _interopRequireDefault(_mobiles);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var mobileTitle = 'Мобильные телефоны';


_reactDom2.default.render(_react2.default.createElement(_ProductsBlock2.default, {
    title: mobileTitle,
    products: _mobiles2.default
...
var _MobileBlock = __webpack_require__(29);

var _MobileBlock2 = _interopRequireDefault(_MobileBlock);

var _MobileCard = __webpack_require__(31);
...
var ProductsBlock = function (_React$Component) {
    ...
    _createClass(ProductsBlock, [{
        ...
        value: function render() {
            ...
            var productsCode = this.state.products.map(function (elem) {
                return _react2.default.createElement(_MobileBlock2.default, { key: elem.name,
                    name: elem.name,
                    price: elem.price,
                    img: elem.img,
                    count: elem.count,
                    cbProductActivated: _this2.productActivated,
                    cbEditCard: _this2.editCard,
                    activeProduct: _this2.state.activeProduct
                });
            });
            var mobileCardCode = this.state.products.map(function (elem) {
                return _react2.default.createElement(_MobileCard2.default, { key: elem.name,
                    name: elem.name,
                    price: elem.price,
                    img: elem.img,
                    count: elem.count,
                    ableKey: _this2.state.activeProduct,
                    editCard: _this2.state.editCard,
                    cbProductActivated: _this2.productActivated,
                    cbSaveProduct: _this2.saveProduct,
                    cbChangeProduct: _this2.changeProduct

                });
            });
            var newMobileCardCode = _react2.default.createElement(_MobileCard2.default, {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'button', value: '\u041D\u043E\u0432\u044B\u0439', onClick: this.createProduct }),
...
var MobileBlock = function (_React$Component) {
    _inherits(MobileBlock, _React$Component);
    ...
    function MobileBlock() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MobileBlock.__proto__ || Object.getPrototypeOf(MobileBlock)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.mobileActivated = function () {
            _this.props.cbProductActivated(_this.props.name);
        }, _this.deleteMobile = function (e) {
            e.stopPropagation();
            var flag = confirm('Удалить элемент?');
            _this.props.cbProductActivated(null);
            _this.setState({ deletemobile: flag });
        }, _this.editCard = function (e) {
            e.stopPropagation();
            _this.props.cbEditCard(_this.props.name);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }
...
MobileBlock.propTypes = {
    ...
    img: _propTypes2.default.string.isRequired,
    count: _propTypes2.default.number.isRequired,
    cbProductActivated: _propTypes2.default.func.isRequired,
    cbEditCard: _propTypes2.default.func.isRequired
};
...
var MobileCard = function (_React$Component) {
    _inherits(MobileCard, _React$Component);
    ...
    function MobileCard() {
        ...
        _classCallCheck(this, MobileCard);
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MobileCard.__proto__ || Object.getPrototypeOf(MobileCard)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.saveEdit = function () {
            ...
            if (!price.match(regexNum)) {
                _this.setState({ priceError: true });
                flag = false;
            } else {
                price = parseInt(price);
                _this.setState({ priceError: false });
            }
            var img = document.querySelector('input.imgInput').value;
            var regexImg = new RegExp(/\.jpeg$/);
            if (!img.match(regexImg)) {
                _this.setState({ imgError: true });
                flag = false;
            } else _this.setState({ imgError: false });
            var count = document.querySelector('input.countInput').value;
            if (!count.match(regexNum)) {
                _this.setState({ countError: true });
                flag = false;
            } else {
                count = parseInt(count);
                _this.setState({ countError: false });
            }
            if (flag) {
                if (!_this.props.createCard) {
                    _this.props.cbChangeProduct(_this.props.name, name, price, img, count);
                } else _this.props.cbSaveProduct(name, price, img, count);
            }
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }
    ...
    _createClass(MobileCard, [{
        ...
        value: function render() {
            ...
            var editCard = _react2.default.createElement(
                ...
                _react2.default.createElement('input', _extends({ className: 'nameInput', type: 'text'
                }, this.props.createCard ? { placeholder: 'Введите название товара' } : { defaultValue: this.props.name })),
                _react2.default.createElement('br', null),
                _react2.default.createElement(
                    'label',
                    null,
                ...
                _react2.default.createElement('input', _extends({ className: 'priceInput', type: 'text'
                }, this.props.createCard ? { placeholder: 'Введите цену товара' } : { defaultValue: this.props.price })),
                ...
                _react2.default.createElement('input', _extends({ className: 'imgInput', type: 'text'
                }, this.props.createCard ? { placeholder: 'Введите изображение товара' } : { defaultValue: this.props.img })),
                ...
                _react2.default.createElement('input', _extends({ className: 'countInput', type: 'text'
                }, this.props.createCard ? { placeholder: 'Введите колличество товара' } : { defaultValue: this.props.count })),
...
module.exports = [{"name":"Xiaomi Redmi 4X 16GB Black","price":295,"img":"Xiaomi%20Redmi%204X%2016GB%20Black.jpeg","count":28},{"name":"Samsung Galaxy A5 (2017) Black [A520F]","price":645,"img":"Samsung%20Galaxy%20A5%20(2017)%20Black%20%5BA520F%5D.jpeg","count":33},{"name":"Huawei P8 lite 2017 (черный)","price":385,"img":"Huawei%20P8%20lite%202017%20(черный).jpeg","count":25},{"name":"Nokia 8 Dual SIM (глянцевый индиго)","price":990,"img":"Nokia%208%20Dual%20SIM%20(глянцевый%20индиго).jpeg","count":17}]
